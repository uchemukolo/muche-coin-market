    ...
    <div className="collapse navbar-collapse" id="navbarText">
      <ul className="navbar-nav mx-auto">
        <li className="nav-item">
          <a className="nav-link" href="https://coincap.io/">Coins <span className="sr-only">(current)</span></a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="https://coincap.io/exchanges">Exchanges</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="https://coincap.io/charts">Charts</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="https://docs.coincap.io/">API</a>
        </li>
